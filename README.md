...
A Clojure library for wielding SQL.
...
select a specific set of columns or choose the order direction, then a
...
The built-in parameter types are detailed below along with details on
extending these types and creating new types.
