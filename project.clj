(defproject com.layerware/hugsql "0.5.0"
  ...
  :dependencies [[org.clojure/clojure "1.8.0"]
                 [com.layerware/hugsql-core "0.5.0"]
                 [com.layerware/hugsql-adapter-clojure-java-jdbc "0.5.0"]]
  ...
  :profiles {:dev
             {:plugins [[lein-codox "0.10.7"]
              ...
              :dependencies [[com.layerware/hugsql-adapter-clojure-jdbc "0.5.0"]
                             [com.layerware/hugsql-adapter-next-jdbc "0.5.0"]]
              :codox {:source-uri "http://github.com/layerware/hugsql/blob/0.5.0/{filepath}#L{line}"
