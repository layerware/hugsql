(defproject com.layerware/hugsql "0.1.1"
  ...
  :dependencies [[org.clojure/clojure "1.7.0"]
                 ...
                 [com.layerware/hugsql-adapter-clojure-java-jdbc "0.1.1"]]
  :profiles {:dev
             {:plugins [[lein-codox "0.9.0"]
              ...
              :dependencies [[com.layerware/hugsql-adapter-clojure-jdbc "0.1.1"]]
              :codox {:source-uri "http://github.com/layerware/hugsql/blob/0.1.1/{filepath}#L{line}"
