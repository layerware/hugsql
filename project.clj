(defproject com.layerware/hugsql "0.3.0"
  :description "A Clojure library for embracing SQL"
  :url "https://github.com/layerware/hugsql"
  :license {:name "Apache License, Version 2.0"
            :url "http://www.apache.org/licenses/LICENSE-2.0.html"}
  :dependencies [[org.clojure/clojure "1.7.0"]
                 [com.layerware/hugsql-core "0.3.0"]
                 [com.layerware/hugsql-adapter-clojure-java-jdbc "0.3.0"]]
  ...
  :profiles {:dev
             {:plugins [[lein-codox "0.9.0"]
              ...
              :dependencies [[com.layerware/hugsql-adapter-clojure-jdbc "0.3.0"]]
