(defproject com.layerware/hugsql "0.4.0"
  ...
  :dependencies [[org.clojure/clojure "1.7.0"]
                 [com.layerware/hugsql-core "0.4.0"]
                 [com.layerware/hugsql-adapter-clojure-java-jdbc "0.4.0"]]
  ...
  :profiles {:dev
             {:plugins [[lein-codox "0.9.4"]
              ...
              :dependencies [[com.layerware/hugsql-adapter-clojure-jdbc "0.4.0"]]
              :codox {:source-uri "http://github.com/layerware/hugsql/blob/0.4.0/{filepath}#L{line}"
