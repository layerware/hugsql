(defproject com.layerware/hugsql "0.4.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.7.0"]
                 [com.layerware/hugsql-core "0.4.0-SNAPSHOT"]
                 [com.layerware/hugsql-adapter-clojure-java-jdbc "0.4.0-SNAPSHOT"]]
  ...
  :profiles {:dev
             {:plugins [[lein-codox "0.9.0"]
              ...
              :dependencies [[com.layerware/hugsql-adapter-clojure-jdbc "0.4.0-SNAPSHOT"]]
              :codox {:source-uri "http://github.com/layerware/hugsql/blob/0.3.1/{filepath}#L{line}"
